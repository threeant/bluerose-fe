...
const AlbumForm = React.lazy(() => import('./views/music/AlbumForm'))
...
const routes = [
  ...
  { path: '/music/albumForm/:albumId', name: 'AlbumDetail', element: AlbumForm },
  { path: '/music/albumForm', name: 'AlbumForm', element: AlbumForm },
